...
public class LeaveRequestDTO {
    ...
    @Schema(description = "Employee email address", example = "john.doe@ecovale.com", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Leave start date (must be future date)", example = "2026-02-15", requiredMode = Schema.RequiredMode.REQUIRED)
    private LocalDate startDate;
    
    @NotNull(message = "End date is required")
    @Future(message = "End date must be in the future")
    @Schema(description = "Leave end date (must be >= start date)", example = "2026-02-17", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Reason for leave request", example = "Personal work and family commitment", 
            minLength = 10, maxLength = 1000, requiredMode = Schema.RequiredMode.REQUIRED)
